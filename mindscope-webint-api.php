		...
		<form id='mwaform' class='needs-validation' novalidate action='{$post_link}' method='post' enctype='multipart/form-data'>
		  ...
		  <div class='form-group row'>
			<div class='col-10'>
				<div class='custom-file' >
					...
					<label class='custom-file-label d-flex' for='validatedCustomFile' style='font-weight: normal; overflow: hidden; text-overflow: ellipsis; display: none;' >Choose resume file...</label>
		  ...
		  <div class='form-group row'>
			<div class='col-sm-10'>
			  ...
			  <br />
			  <button id='btnMwaFormSubmit' type='submit' class='btn btn-primary btn-lg' name='mwa_form_apply' style='background-color: #EAB455 !important; border-color: #EAB455 !important;'>
...
function generate_job_card ($value)
{
	...
	<div class='container d-none d-lg-block' style='padding-left: 0px; padding-right: 0px;'>
		<div class='row'>
			<div class='col-9'>
		...
		<div class='row'>
			<div class='col-12' style='margin-top: -10px;'>
				<p class='font-weight-light text-capitalize'><i class='fas fa-map-marker-alt' style='margin-right: 5px;'></i>{$lower_city}</p>
			</div>
		</div>
	</div>
	...
	//$return_list .= "<p class='font-weight-light text-capitalize' style='margin-bottom: 0px; margin-top: 5px;'><i class='fas fa-map-marker-alt' style='margin-right: 5px;'></i>{$lower_city}</p>";
	...
	$return_list .= "<p class='card-text'>{$brief_description}</p>";
	$return_list .= "</div>";
	$return_list .= "</div>";
	$return_list .= "<br>";
	$return_list .= "</div>";
...
function mindscope_ajax_job_list_function()
{
	...
	$filter = json_encode(array('Filter'=>(
											array('JobOrderDivisionSet'=>$division, 'ProvinceStateNameSet'=>$state, 'EmploymentTypeNameSet'=>$employment, 'Keyword'=> $keyword)),
								'Order'=> array(
	...
	$return_list .= "<h5>@TotalJobs Jobs found</h5><br/>";
...
<div id='api-job-list' class='container' style='display: none;'>
	...
	<div class='row'>
		...
		<div class='col-2 d-md-block d-lg-none' style='background-color: white;'>
			<button type='button' class='btn btn-primary api-background-color api-border-color btn-lg api-search-button' style='margin-left: -20px;'><i class='fas fa-search'></i></button>
		</div>
	</div>		
	<div class='row'>
		<div class='col-md-1 d-none d-lg-block' >
		...
		<div class='col-md-2 d-none d-lg-block' >
			<button type='button' class='btn btn-primary api-background-color api-border-color btn-lg api-search-button' style='margin-top: -20px;'>Search <i class='fas fa-search'></i></button>
		</div>
		<div class='col-md-1 d-none d-lg-block' >
		</div>
	</div>		
...
<div id='apiFilters' class='col-md-3'> 
	...
	<div class='accordian' id='filter2accordian'>	
...
";
		...
		foreach($division_arr as $value)
		{
			...
			<div class='form-check custom-control custom-checkbox' style='margin-bottom: 7px;'>
			  ...
			  <label class='custom-control-label' for='divisionCheck{$division_count}'>
			  {$value}
			  </label>
			</div>			
			";
		...
		foreach ($state_arr as $value)
		{
			...
			<div class='form-check custom-control custom-checkbox' style='margin-bottom: 7px;'>
			  ...
			  <label class='custom-control-label' for='stateCheck{$state_count}'>
			  {$value}
			  </label>
			</div>			
			";
		...
		foreach ($employment_arr as $value)
		{
			...
			<div class='form-check custom-control custom-checkbox' style='margin-bottom: 7px;'>
			  ...
			  <label class='custom-control-label' for='employmentCheck{$employment_count}'>
			  {$value}
			  </label>
			</div>
			";
